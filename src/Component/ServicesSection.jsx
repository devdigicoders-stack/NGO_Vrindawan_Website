                ...
                <div className="relative z-10 h-full p-8 flex flex-col">
                  ...
                  <div className="mt-auto">
                    ...
                    <div className={`border-t pt-5 transition-colors duration-500 ${isActive ? 'border-white/20' : 'border-gray-200/50'}`}>
                      <Link to="/life-at-aanandam" className={`inline-flex items-center text-sm font-bold uppercase tracking-wider transition-colors duration-500 ${isActive ? 'text-white hover:text-[#FDD835]' : 'text-[#0a231a] hover:text-[#FDD835]'}`}>
                        Read More
