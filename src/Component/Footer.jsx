        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3 text-[15px] flex flex-col items-center md:items-start">
              ...
              <li><Link to="/donate" className="hover:text-[#FDD835] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#FDD835] rounded-full"></span> Donate Now</Link></li>
              <li><Link to="/sponsor-a-meal" className="hover:text-[#FDD835] transition-colors flex items-center gap-2"><span className="w-1 h-1 bg-[#FDD835] rounded-full"></span> Sponsor A Meal</Link></li>
